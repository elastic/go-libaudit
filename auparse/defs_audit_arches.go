...
const (
	...
	AUDIT_ARCH_C6X         AuditArch = C.AUDIT_ARCH_C6X
	AUDIT_ARCH_C6XBE       AuditArch = C.AUDIT_ARCH_C6XBE
	AUDIT_ARCH_CRIS        AuditArch = C.AUDIT_ARCH_CRIS
	AUDIT_ARCH_FRV         AuditArch = C.AUDIT_ARCH_FRV
	AUDIT_ARCH_H8300       AuditArch = C.AUDIT_ARCH_H8300
	AUDIT_ARCH_I386        AuditArch = C.AUDIT_ARCH_I386
	AUDIT_ARCH_IA64        AuditArch = C.AUDIT_ARCH_IA64
	AUDIT_ARCH_LOONGARCH32 AuditArch = C.AUDIT_ARCH_LOONGARCH32
	AUDIT_ARCH_LOONGARCH64 AuditArch = C.AUDIT_ARCH_LOONGARCH64
	...
	AUDIT_ARCH_NIOS2       AuditArch = C.AUDIT_ARCH_NIOS2
